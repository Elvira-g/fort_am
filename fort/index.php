...
<body>
        ...
        <div class="modal-equipment-window">
            ...
            <div class="modal-equipment-items-block">
                <div class="modal-equipment-text-block">
                    <h2 class="modal-equipment-title" data-tr='equip-modal-h1'></h2>
                    <p class="modal-equipment-text" data-tr='equip-modal-text'></p>
                    <p class="modal-equipment-subtitle" data-tr='equip-modal-subtitle'>Оборудование</p>
        ...
        <div class="container">
            <nav class="nav">
                ...
                <div class="menu-block">
                    <ul class="menu-list">
                        <li class="menu-item"><a href="#price" class="menu-item-link" data-tr="price">Цены</a></li>
                        <!-- <li class="menu-item"><a href="#benefits" class="menu-item-link">Преимущества</a></li> -->
                        <li class="menu-item"><a href="#equipment" class="menu-item-link" data-tr='services'>Услуги</a></li>
                        <li class="menu-item"><a href="#about" class="menu-item-link" data-tr='about'>О компании</a></li>
                        <li class="menu-item"><a href="#contacts" class="menu-item-link" data-tr='contacts'>Контакты</a></li>
                    </ul>
                    <div class="container">
                        <button class="btn-main call-btn nav-btn-mob" data-tr='call-btn'>Заказать звонок</button>
                    </div>
                </div>
                <div class="lang-block">
                    <p class="lang-block-link lang-ru" data-lang='ru'>ru</p>
                    <span class='lang-block-span'>|</span>
                    <p class="lang-block-link lang-am hidden" data-lang='am'>am</p>
                </div>
                <div class="call-block">
                    <p class="call-number">+7 495 877-47-39</p>
                    <button class="btn-main call-btn nav-btn" data-tr='call-btn'>Заказать звонок</button>
                </div>
    ...
    <main class="main">
        <section class="hero">
            ...
            <div class="container">
                <h1 class="hero-title" data-tr='hero-title'>Вневедомственная охрана квартир, дома, бизнеса</h1>
                <div class="hero-benefits-block">
                    <div class="hero-benefits-item hero-benefits-first-child"><span class="hero-benefits-text-end" data-tr='hero-price'>Стоимость от </span> <span class="hero-benefits-text" data-tr='hero-price-num'>890 ₽</span> <span class="hero-benefits-text-end" data-tr='hero-price-end'> в месяц</span></div>
                    <div class="hero-benefits-item"><span class="hero-benefits-text-end" data-tr='hero-time'>Определим ближайший к вам экипаж. Расчетное время прибытия от </span> <span class="hero-benefits-text" data-tr='hero-time-num'>5 мин</span></div>
                    <div class="hero-benefits-item"><span class="hero-benefits-text-end" data-tr='hero-resp'>Ответственность до </span><span class="hero-benefits-text" data-tr='hero-resp-num'> 1 000 000 ₽</span> </div>
                </div>
                <button class="btn-orange hero-btn call-btn" data-tr='hero-btn'>Оставить заявку</button>
            </div>
        </section>
        <!-- <aside class="banner">
            <div class="container">
        ...
        <section class="price todelete" id="price">
            <div class="container">
        ...
        <section class="price" >
            <div class="container">
                <h2 class="section-title price-title" data-tr='rates'>Тарифы на охрану ЧОП</h2>
                <div class="price-items-block">
                    <div class="price-item price-item-prices">
                        <h3 class="price-item-title" data-tr='rates-flat'>Охрана квартиры</h3>
                        <div class="price-item-number-block">
                            <p class="price-item-number">1 000</p>
                            <table class="price-number-text">
                                <tr>
                                    <td data-tr='currency'>руб.</td>
                                </tr>
                                <tr>
                                    <td data-tr='month'>мес</td>
                                </tr>
                            </table>
                        </div>
                        <button class="btn-main price-item-btn call-btn" data-tr='order-btn'>Заказать</button>
                    </div>
                    <div class="price-item price-item-prices">
                        <h3 class="price-item-title" data-tr='rates-house'>Охрана дома</h3>
                        <div class="price-item-number-block">
                    ...
                    <div class="price-item price-item-prices">
                        <h3 class="price-item-title" data-tr='rates-busines'>Охрана бизнеса</h3>
                        <div class="price-item-number-block">
                    ...
                    <div class="price-item">
                        <ul class="section-list">
                            <li class="section-list-item" data-tr='rates-time'>Время приезда 10 минут</li>
                            <li class="section-list-item" data-tr='rates-crew'>300 экипажей ЧОП в Москве и области</li>
                            <li class="section-list-item" data-tr='rates-liability'>Материальная ответственность<br>до 1 000 000 руб.</li>
                            <li class="section-list-item" data-tr='rates-system'>Управление системой со смартофна</li>
                        </ul>
                    </div>
                </div> 
            </div>      
        ...
        <section class="equipment" id="equipment">
            <div class="container">
                <h2 class="section-title equipment-title" data-tr='equipment'>Оборудование</h2>
                <div class="equipment-items-block">
                    <div class="equipment-item">
                        ...
                        <h3 class="equipment-item-title" data-tr='alarm'>Охранная сигнализация</h3>
                        <p class="equipment-item-text" data-tr='alarm-desc'>Охранная сигнализация защитит от проникновения, взлома ночью</p>
                        <p class="equipment-item-price">9 050</p>
                        <p class="equipment-item-currency" data-tr='currency'>руб.</p>
                        <button class="btn-main equipment-btn call-btn" data-tr='buy-btn'>Купить систему</button>
                    </div>
                    <div class="equipment-item">
                        ...
                        <h3 class="equipment-item-title" data-tr='button'>Тревожная кнопка</h3>
                        <p class="equipment-item-text" data-tr='button-desc'>Тревожная кнопка необходима для защиты от нападения</p>
                    ...
                    <div class="equipment-item">
                        ...
                        <img src="./assets/img/nord.jpg" alt="" class="equipment-item-img">
                        <h3 class="equipment-item-title" data-tr='combo'>Охранная сигнализация<br>+ тревожная кнопка</h3>
                        <p class="equipment-item-text" data-tr='combo-desc'>Комплексная защита</p>
            ...
            <div class="container">
                <div class="benefits-items-block">
                    <div class="benefits-item">
                        ...
                        <h3 class="benefits-item-title" data-tr='free-connection'>Подключение бесплатно!</h3>
                        <p class="benefits-item-text" data-tr='free-connection-desc'>Для клиентов с уже установленным оборудованием</p>
                        <button class="btn-main benefits-item-btn call-btn" data-tr='connection-btn'>Подключить бесплатно</button>
                    </div>
                    <div class="benefits-item">
                        <img src="./assets/svg/adv_2.svg" alt="" class="benefits-item-img">
                        <h3 class="benefits-item-title" data-tr='urgent-connection'>Срочное подключение</h3>
                        <p class="benefits-item-text" data-tr='urgent-connection-desc'>Приедем на установку оборудования в день обращения!</p>
                        <button class="btn-main benefits-item-btn call-btn" data-tr='connection-btn'>Подключить бесплатно</button>
                    </div>
                    <div class="benefits-item">
                        <img src="./assets/svg/adv_3.svg" alt="" class="benefits-item-img">
                        <h3 class="benefits-item-title" data-tr='instalments'>Рассрочка</h3>
                        <p class="benefits-item-text" data-tr='instalments-desc'>Предоставим вам рассрочку на выгодных условиях без договора с банком.</p>
                        <button class="btn-main benefits-item-btn call-btn" data-tr='connection-btn'>Подключить бесплатно</button>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="smart-main-block">
                    <div class="smart-text-block">
                        <h2 class="section-title smart-title" data-tr='smart'>Управляйте системой прямо со смартфона</h2>
                        <ul class="section-list">
                            <li class="section-list-item" data-tr='smart-1'>Мгновенно узнавайте о тревогах с помощью push, смс или звонка </li>
                            <li class="section-list-item" data-tr='smart-2'>Получайте напоминания о постановке и снятии с охраны</li>
                            <li class="section-list-item" data-tr='smart-3'>Контролируйте показатели устройств в реальном времени</li>
                        </ul>
                        <div class="smart-icons-block">
                            <div class="smart-icon">
                                <img src="./assets/svg/android.svg" alt="" class="smart-icon-img">
                                <p class="smart-icon-text" data-tr='smart-andr'>Скачать для Android</p>
                            </div>
                            <div class="smart-icon">
                                <img src="./assets/svg/apple.svg" alt="" class="smart-icon-img">
                                <p class="smart-icon-text" data-tr='smart-i'>Скачать для iPhone</p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="clients">
            <div class="container">
                <h2 class="section-title clients-title" data-tr='clients'>Нам доверяют крупный и малый бизнес</h2>
                <p class="section-text" data-tr='clients-desc'>Каждую компанию вы можете проверить и убедиться, что мы с ними работаем</p>
        ...
        <section class="call-form-main">
            <div class="call-form-main-block">
                <div class="call-form-text-block">
                    <h2 class="section-title call-form-title" data-tr='call-title'>Оставить заявку на подключение</h2>
                    <p class="section-text" data-tr='call-text'>Поможем подобрать оптимальную систему для вашей квартиры, согласуем удобную для вас дату и время установки.</p>
                </div>
                <div class="call-form-block">
                    <form class="call-form">
                        <input type="text" class="form-name-placeholder" name="name" placeholder="ФИО" autocomplete="off">
                        <input type="tel" class="tel form-tel-placeholder" name="tel" placeholder="Мобильный телефон" autocomplete="off">
                        <div class="error"></div>
                        <p class="call-form-policy-text" data-tr='form-policy'>Отправляя заявку, Вы даете согласие на обработку <a class="call-form-policy-link" href="./policy.php" data-tr='form-policy-link'>персональных данных</a></p>
                        <button type="submit" class="btn-orange call-form-btn" data-tr='send-btn'>Отправить</button>
                    </form>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="about-items-block">
                    <div class="about-item-text-block">
                        <h2 class="section-title about-title" data-tr='about-title'>Компания федерального уровня</h2>
                        <p class="section-text" data-tr='about-text-1'>Форт — ваш качественный охранный сервис. Собственный колл-центр решит любую проблему. Вам не придется ждать, пока специалисты будут перекидывать друг другу ваше обращение — вам поможет первый оператор, которому вы дозвонились.</p>
                        <p class="section-text" data-tr='about-text-2'>Отвечаем не до нескольких миллионов, до 1 миллиона. Быстро обработаем заявку и установим систему в удобное вам время. - добавить предложение</p>
                    </div>
                    <div class="about-item-icons-block">
                        <div class="about-icon">
                            <p class="about-icon-number">2000+</p>
                            <p class="about-icon-text" data-tr='circle-1'>постоянных клиентов</p>
                        </div>
                        <div class="about-icon">
                            <p class="about-icon-number">24/7</p>
                            <p class="about-icon-text" data-tr='circle-2'>режим работы</p>
                        </div>
                        <div class="about-icon">
                            <p class="about-icon-number">150+</p>
                            <p class="about-icon-text" data-tr='circle-3'>сотрудников</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="contacts" id="contacts">
            ...
            <div class="container">
                <div class="contacts-form-block">
                    <h2 class="section-title contacts-title" data-tr='contacts-title'>Нужна помощь в выборе охраны?</h2>
                    <form class="contacts-form">
                        <input type="text" class="name form-name-placeholder" name="name" placeholder="ФИО" autocomplete="off">
                        <input type="tel" class="tel form-tel-placeholder" name="tel" placeholder="Телефон" autocomplete="off">
                        <div class="error"></div>
                        <input type="email" name="email" placeholder="Email" autocomplete="off" class="email">
                        <p class="call-form-policy-text mobile-policy" data-tr='form-policy'>Отправляя заявку, Вы даете согласие на обработку <a class="call-form-policy-link" href="./policy.php" data-tr='form-policy-link'>персональных данных</a></p>
                        <button type="submit" class="btn-orange contacts-btn" data-tr='call-me'>Перезвоните мне</button>
                    </form>
                    <p class="call-form-policy-text desctop-policy" data-tr='form-policy'>Отправляя заявку, Вы даете согласие на обработку <a class="call-form-policy-link" href="./policy.php" data-tr='form-policy-link'>персональных данных</a></p>
                </div>
            </div>
        </section>
    </main>
        ...
        <div class="container">
            <div class="footer-items-block">
                ...
                <div class="footer-menu-block">
                    <ul class="footer-menu-list">
                        <li class="footer-menu-item"><a href="#price" class="footer-menu-link" data-tr="price">Цены</a></li>
                        <!-- <li class="footer-menu-item"><a href="#benefits" class="footer-menu-link">Преимущества</a></li> -->
                        <li class="footer-menu-item"><a href="#" class="footer-menu-link" data-tr='services'>Услуги</a></li>
                        <li class="footer-menu-item"><a href="#about" class="footer-menu-link" data-tr='about'>О компании</a></li>
                        <li class="footer-menu-item"><a href="#contacts" class="footer-menu-link" data-tr='contacts'>Контакты</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-items-second-block">
                <div class="footer-rights-block">
                    <p class="footer-rights" data-tr='rights'>© Форт 2022. Все права защищены.</p>
                </div>
                ...
                <div class="footer-policy-block">
                    <p class="ya-policy-text"><a href="./policy.php" class="ya-policy-link" data-tr='policy-link'>Политика конфиденциальности</a></p>
                </div>
            </div>
        </div>
    </footer>
